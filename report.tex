...
\begin{titlepage}
    ...
    \begin{minipage}[t]{1\textwidth}
        ...
        \captionof{figure}{\textit{Visualised with Pyvis, depicts the best Hamiltonian path that could be solved for. The GA found using the 2-OPT (inversion) operator in the Erdős-Rényi random graph. Broken edges are depicted in red.}}
    \end{minipage}
    \vspace{0.3cm}
